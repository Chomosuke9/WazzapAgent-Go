...
func (capability Capability) Valid() bool {
	switch capability {
	case CapabilityCommandHelp, CapabilityCommandInfo, CapabilityCommandGroup, CapabilityHistoryReset, CapabilityPromptWrite, CapabilityPermissionWrite, CapabilityCommandExecute,
