...
import type { AgentRuntimeStatusDTO, ApplyAgentSettingsRequestDTO, AppInfo, BeginWhatsAppPairingRequestDTO, FieldDescriptorDTO, LogEntryDTO, PingEvent, ResetWhatsAppChatSettingsRequestDTO, ResetWhatsAppChatSettingsResultDTO, SaveSettingsRequestDTO, SaveSettingsResultDTO, SaveWhatsAppChatSettingsRequestDTO, ScheduleWhatsAppBroadcastRequestDTO, SendWhatsAppBroadcastRequestDTO, SettingsPatchDTO, SettingsValuesDTO, SettingsViewDTO, ValidationResultDTO, WhatsAppBroadcastGroupDTO, WhatsAppBroadcastGroupResultDTO, WhatsAppBroadcastScheduleDTO, WhatsAppChatSettingsDTO, WhatsAppConversationDTO, WhatsAppGroupMemberDTO, WhatsAppGroupMembersDTO, WhatsAppMentionDTO, WhatsAppMessageDTO, WhatsAppQuoteDTO, WhatsAppSessionEventDTO, WhatsAppSessionOperationDTO, WhatsAppSessionStatusDTO } from "../../bindings/github.com/Chomosuke9/WazzapAgent-Go/internal/adapters/wails/models";
export type { AgentRuntimeStatusDTO, ApplyAgentSettingsRequestDTO, AppInfo, BeginWhatsAppPairingRequestDTO, FieldDescriptorDTO, LogEntryDTO, PingEvent, ResetWhatsAppChatSettingsRequestDTO, ResetWhatsAppChatSettingsResultDTO, SaveSettingsRequestDTO, SaveSettingsResultDTO, SaveWhatsAppChatSettingsRequestDTO, ScheduleWhatsAppBroadcastRequestDTO, SendWhatsAppBroadcastRequestDTO, SettingsPatchDTO, SettingsValuesDTO, SettingsViewDTO, ValidationResultDTO, WhatsAppBroadcastGroupDTO, WhatsAppBroadcastGroupResultDTO, WhatsAppBroadcastScheduleDTO, WhatsAppChatSettingsDTO, WhatsAppConversationDTO, WhatsAppGroupMemberDTO, WhatsAppGroupMembersDTO, WhatsAppMentionDTO, WhatsAppMessageDTO, WhatsAppQuoteDTO, WhatsAppSessionEventDTO, WhatsAppSessionOperationDTO, WhatsAppSessionStatusDTO };
