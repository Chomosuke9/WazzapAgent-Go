...
import type { AgentRuntimeStatusDTO, ApplyAgentSettingsRequestDTO, AppInfo, BeginWhatsAppPairingRequestDTO, FieldDescriptorDTO, LogEntryDTO, PingEvent, SaveSettingsRequestDTO, SaveSettingsResultDTO, SaveWhatsAppChatSettingsRequestDTO, SettingsPatchDTO, SettingsValuesDTO, SettingsViewDTO, ValidationResultDTO, WhatsAppChatSettingsDTO, WhatsAppConversationDTO, WhatsAppGroupMemberDTO, WhatsAppGroupMembersDTO, WhatsAppMessageDTO, WhatsAppSessionEventDTO, WhatsAppSessionOperationDTO, WhatsAppSessionStatusDTO } from "../../bindings/github.com/Chomosuke9/WazzapAgent-Go/internal/adapters/wails/models";
export type { AgentRuntimeStatusDTO, ApplyAgentSettingsRequestDTO, AppInfo, BeginWhatsAppPairingRequestDTO, FieldDescriptorDTO, LogEntryDTO, PingEvent, SaveSettingsRequestDTO, SaveSettingsResultDTO, SaveWhatsAppChatSettingsRequestDTO, SettingsPatchDTO, SettingsValuesDTO, SettingsViewDTO, ValidationResultDTO, WhatsAppChatSettingsDTO, WhatsAppConversationDTO, WhatsAppGroupMemberDTO, WhatsAppGroupMembersDTO, WhatsAppMessageDTO, WhatsAppSessionEventDTO, WhatsAppSessionOperationDTO, WhatsAppSessionStatusDTO };
...
export const sendWhatsAppMessage = (chatID: string, text: string): Promise<WhatsAppMessageDTO> => SendWhatsAppMessage(chatID, text);
